...
```
**Figure S1**. Estimated percentage of code-sharing practices in the ecological journals reviewed. Journals are grouped by the level of the code-sharing policy, and numbers represent the percentages.

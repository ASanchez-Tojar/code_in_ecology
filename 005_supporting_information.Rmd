...
# number of articles using repositories to host their data
code.hosted.repository <- as.numeric(table(data.full$LocationShared.2)["repository"])
...
all.names <- c("articles sharing at least some code",
               ...
               "articles sharing at least some code and hosting it in a repository",
...
all.percentages <- round(
  c((at.least.some.code/eligible.articles.code)*100,
    ...
    (code.hosted.repository.2018.19/at.least.some.code.year$code_published[2])*100),0)
...
all.numerators <- c("#eligible articles with at least some code",
                    ...
                    "#eligible articles with at least some code in 2015/2016",
                    "#eligible articles with at least some code in 2018/2019",
                    "#eligible articles per journal with at least some code",
                    "#eligible articles per journal with at least some code",
                    "#eligible articles per journal with at least some code",
                    "#eligible articles per journal with at least some code",
                    "#eligible articles with at least some code that highlighted code availability",
                    "#eligible articles with at least some code that highlighted code availability using code and/or script",
                    "#eligible articles with at least some code that highlighted code availability in data accessibility and/or methods section",
                    "#eligible articles with at least some code that highlighted code availability only in the supplements",
                    "#eligible articles with at least some code that did not highlighted code availability",
                    "#eligible articles with at least some code and hosting it in a repository",
                    "#eligible articles with at least some code and hosting it only in the supplements",
                    "#eligible articles sharing at least some code and hosting it in a repository in 2015/2016",
                    "#eligible articles sharing at least some code and hosting it in a repository in 2018/2019")
...
all.denominators <- c("#eligible articles",
                      ...
                      "#eligible articles per journal",
                      "#eligible articles per journal",
                      "#eligible articles with at least some code",
                      "#eligible articles with at least some code that highlighted code availability",
                      "#eligible articles with at least some code that highlighted code availability",
                      "#eligible articles with at least some code that highlighted code availability",
                      "#eligible articles with at least some code",

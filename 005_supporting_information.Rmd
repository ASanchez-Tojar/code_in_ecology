...
**Figure S1**. Estimated percentage of code-sharing practices in the `r table(journal.policies$Require.computer.code.with.publication_2015)['Yes']` ecological journals reviewed. Journals are grouped by the strength of the code-sharing policy, and numbers represent percentages.

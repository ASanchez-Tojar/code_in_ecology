...
all.percentages <- round(
  c((at.least.some.code/eligible.articles.code)*100,
    ...
    (seemingly.all.code.and.data.year$code_and_data_published[2]/eligible.articles.code.year$eligible_articles[2])*100),0)
...
**Table S2**. List of all percentages that we calculated and presented from our data in the main manuscript, and how they were calculated to avoid any misunderstanding. Percentages sorted by the order of appearance in the main manuscript (including the abstract).

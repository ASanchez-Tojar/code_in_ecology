...
```
**Figure S1**. Ecological journals reviewed and their estimated percentage of code-sharing articles. Journals are grouped by the level of the code-sharing policy, and numbers represent percentages.

## R Session Information

R session information detailing the versions and packages used for reproducibility purposes.
